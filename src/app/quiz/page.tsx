...
import { QUIZ_TIME_SECONDS } from '@/lib/utils/sections';
  ...
  if (loading) {
    return (
      <div className="text-center py-20">
        ...
        <div className="text-xs text-gray-300">This may take 15–30 seconds on first visit</div>
      </div>
    );
  }
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-400">
            {currentIndex + 1} of {quizData.questions.length} questions &middot; {answers.size} answered
          </p>
        </div>
        <div className="flex items-center gap-4">
          <ExamTimer timeLimitSeconds={QUIZ_TIME_SECONDS} onTimeUp={submitQuiz} />
          <button
            onClick={submitQuiz}
            disabled={submitting}
