...
import { StudyCard, SECTION_LABELS, SECTION_COLORS, Section } from '@/types';
    ...
    <div className="flex flex-col items-center gap-6">
      ...
      >
        ...
        >
          ...
          >
            <span className={`text-xs px-2 py-1 rounded-full font-medium self-start ${SECTION_COLORS[card.topic as Section]}`}>
              {SECTION_LABELS[card.topic as Section]}
            </span>
