...
import { TopicBreakdown, SECTION_LABELS, Section } from '@/types';
...
export function ResultsChart({ topicBreakdown }: ResultsChartProps) {
  const data = Object.entries(topicBreakdown)
    ...
    .map(([section, { correct, total }]) => ({
      name: SECTION_LABELS[section as Section] ?? section,
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-6">
      <h3 className="text-sm font-semibold text-gray-700 mb-4">Performance by Section</h3>
